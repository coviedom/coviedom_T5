...
* - TIMX DIER (DMA and Interrupt enable register)
...
void timer_set_period(Timer_Handler_t *pTimerHandler) {
    ...
    assert_param(IS_TIMER PERIOD(pTimerHandler->TIMx_Config. TIMx_Prescaler));
 ...
 * Se debe utilizar usando exactamente el mismo nombre definido en el vector de interrupcioes
